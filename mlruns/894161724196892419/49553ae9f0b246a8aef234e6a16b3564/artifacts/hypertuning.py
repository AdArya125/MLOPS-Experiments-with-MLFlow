...
with mlflow.start_run() as parent:
    ...
    # Log the best model
    mlflow.sklearn.log_model(grid_search.best_estimator_, "random_forest", input_example=train_df.head(1))

    # Set tags
    mlflow.set_tag("author", "Aditya")
    mlflow.set_tag("project", "Breast Cancer Classification")
